...
public class MainActivity extends Activity implements EMDKListener, OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pam_activity_main);
        ...
        nameEditText.setText("/sdcard/Download/PackageInfo.apk");
    }
    ...
    private void addSetButtonListener() {
        ...
        setButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(radioid == R.id.radioInstall) {
                        action = "Install";
                        bInstall = true;
                }
                else if(radioid == R.id.radioUpgrade){
                        action = "Upgrade";
                        bInstall = true;
                }
                else if(radioid == R.id.radioUninstall){
                        action = "Uninstall";
                        bInstall = false;
                }
    ...
    public void onCheckedChanged(RadioGroup group, int id) {
        ...
        if(id == R.id.radioInstall || id == R.id.radioUpgrade) {
                bInstall = true;
                helpTextView.setText("APK Name (Ex: /sdcard/TestApp.apk):");
        }
        else if(id == R.id.radioUninstall){
                bInstall = false;
